...
(function(){
  var parser, philtre, sortBy, makeFunc, makeAnd, makeOr, funkifyTerm, tagged, contains, checkField, before, after, data, out$ = typeof exports != 'undefined' && exports || this;
  ...
  funkifyTerm = function(term){
    ...
    if (term.key && term.val) {
      return checkField(term.key, term.val);
    }
    if (term.tag) {
