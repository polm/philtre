...
(function(){
  var tagged, contains, has, before, after, getQuotedString, makeNot, makeOr, getParenString, getUntilCloser, philtreCore, philtre, out$ = typeof exports != 'undefined' && exports || this;
  ...
  philtreCore = function(query){
    var conds, ref$, word, key, value, condsOut, ii;
    conds = [];
    ...
    while (ii < conds.length) {
      if (conds[ii + 1] === "OR") {
        ...
        console.log(conds[ii].toString());
        console.log(conds[ii + 2].toString());
        ii += 3;
        continue;
      }
      if (conds[ii] === "NOT") {
